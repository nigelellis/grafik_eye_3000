...
def setup_platform(hass, config, async_add_entities, discovery_info=None):
    ...
    for switch in discovery_info[CONF_SWITCHES]:
        ...
        devs.append(dev)
    async_add_entities(devs, update_before_add = True) #Do I need to return True?
...
#        self._state = True
    ...
    def update_callback(self, status):
        ...
        _LOGGER.debug("Returned scene for unit %s is %s and scene id is %s", self._unit, status, self._scene)
